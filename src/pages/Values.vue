<template>
  <div class="values">
    <banner>
        ...
        <template #content>
          <p class="nomargin font-big">
            In den Pluspunkten und Abzügen, die eine Person für bestimmte
            Merkmale bekommt, wird die mehrfache Diskriminierung sichtbar. Die
        ...
        <template #more-content>
          <p>
            ...
            Beeinträchtigung(en). Die Basisgruppe bekommt eine Chance von ca.
            52% berechnet. Für jede Abweichung von dieser Basisgruppe werden
            entweder Prozente abgezogen oder dazugerechnet.
          </p>
          <p>
            Beispiel: Eine Person entspricht der Basisgruppe, bis auf den
            Unterschied, dass diese Person das Geschlecht 'weiblich' hat: Von
            52% werden 3.48% abgezogen. Ist diese Person auch noch über 50,
            bekommt sie weitere 17.06% abgezogen.
          </p>
        </template>
    </banner>
    ...
    <inner-wrapper id="barcharts">
      ...
      />
      <bar-chart
        :title="'Merkmale zur Vorkarriere'"
